        ...
        <div class="main-header">
            ...
            <div class="header-text">
                <div class="header-text-inner">
                    <p class="wow fadeIn" data-wow-duration="2s" data-wow-delay=".7s">Leave us a message</p>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="bottom-footer">
                ...
                <div class="copyright">
                    <span>Copyright © 20xx - More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></span>
                </div>
            </div>
        </div>
    </footer>
